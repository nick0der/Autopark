...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 330px">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/freightTransport/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/freightTransport/list">Freight Transport</a></div>
</div>
<div>
    <div class="limiter">
                ...
                <div class="table100">
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            ...
                            <th style="width: 150px">
                                <div class="with-sort">
                                    <div class="sort-text">Load Capacity</div>
                                    <div class="sort-block">
