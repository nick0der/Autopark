...
<div class="wrapper">
    <div class="form-input" style="height: 455px; margin-bottom: 50px">
        <div class="input-header">
            <a href="/web/storageObj/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Storage Object</div>
        </div>
        <form name="storageObj" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>Type:</div><@spring.formSingleSelect "storageObjForm.type", types, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Area:</div><@spring.formInput "storageObjForm.area" "required min='0' max='10000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Number:</div><@spring.formInput "storageObjForm.number" "required min='0' max='10000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Capacity:</div><@spring.formInput "storageObjForm.capacity" "required min='0' max='10000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Chief:</div><@spring.formSingleSelect "storageObjForm.chief", mavs, ""/>
                <br>
            </div>
            <br>
