...
<div class="wrapper">
    <div class="form-input" style="height: 455px">
        <div class="input-header">
            <a href="/web/freightTransport/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Freight Transport</div>
        </div>
        <form name="freightTransport" action="" method="POST" id="form" autocomplete="off">
            ...
            <div class="form-row">
                <div>Load capacity:</div><@spring.formInput "freightTransportForm.loadCapacity" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Type:</div><@spring.formSingleSelect "freightTransportForm.type", types, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Garage:</div><@spring.formSingleSelect "freightTransportForm.storageObj", mavs, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Track №:</div><@spring.formInput "freightTransportForm.trackNumber" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <br>
