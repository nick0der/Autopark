...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 135px;">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/taxi/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/taxi/list">Taxi</a></div>
</div>
<div>
    <div class="limiter">
                    ...
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            ...
                            <th style="width: 175px;">
                                <div class="with-sort">
                                    <div class="sort-text">Body Type</div>
                                    <div class="sort-block">
