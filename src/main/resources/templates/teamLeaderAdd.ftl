...
<div class="wrapper">
    <div class="form-input" style="height: 520px">
        <div class="input-header">
            <a href="/web/teamLeader/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Team Leader</div>
        </div>
        <form name="teamLeader" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>First name:</div><@spring.formInput "teamLeaderForm.firstName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Name'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Last name:</div><@spring.formInput "teamLeaderForm.lastName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Surname'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Patronymic:</div><@spring.formInput "teamLeaderForm.patronymic" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Patromynic'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Salary:</div><@spring.formInput "teamLeaderForm.salary" "required min='0' max='10000000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Experience:</div><@spring.formInput "teamLeaderForm.experience" "required min='0' max='100'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Master:</div><@spring.formSingleSelect "teamLeaderForm.master", mavs, ""/>
                <br>
            </div>
            <br>
