...
<div class="wrapper">
    <div class="form-input" style="height: 325px">
        <div class="input-header">
            <a href="/web/transportation/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Freight Transportation</div>
        </div>
        <form name="transportation" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>Date transported:</div><input id="datepicker" type="text" class="datepicker-class" required name="dateAddedName" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" title="yyyy-mm-dd"/>
                <script src="/js/datepicker.js"></script>
            </div>
            <div class="form-row">
                <div>Transport:</div><@spring.formSingleSelect "transportationForm.freightTransport", mavs, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Weight:</div><@spring.formInput "transportationForm.weight" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <@spring.formInput "transportationForm.dateTransported" "required style='display:none'" "text"/>
            <br>
