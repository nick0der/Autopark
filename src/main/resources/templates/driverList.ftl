...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 165px">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/driver/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/driver/list">Driver</a></div>
</div>
<div>
    <div class="limiter">
                ...
                <div class="table100">
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            <th class="column-l" style="width: 180px;">
                                <div class="with-sort">
                            ...
                            <th style="width: 170px;">
                                <div class="with-sort">
                                    <div class="sort-text">Patronymic</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 170px;">
                                <div class="with-sort">
                                    <div class="sort-text">Transport</div>
                                    <div class="sort-block">
                                ...
                                <script>
                                    $(document).ready(function(){
                                        ...
                                        for (i = 1; i < (document.getElementById("myTable").rows.length); i++) {
                                            ...
                                            var value = document.getElementById("myTable").rows[i].getElementsByTagName("TD")[5].innerHTML;
                                            if ((value.charAt(0) === '1')&&(value.charAt(1) === ' ')){
                                                document.getElementById("myTable").rows[i].getElementsByTagName("TD")[5].innerHTML = '1 year';
                                            }
                                        }
                                    });
                                </script>
                                <td style="text-align: center; width: 70px"><a href="/web/driver/edit/${driver.id}"><img class="edt-img" src="/img/edt-dlt/edit.png"></a></td>
                                <td style="text-align: center; width: 70px" class="column-r"><a onclick="return confirm('Are you sure want to delete? Its impossible to recover the data!')" href="/web/driver/delete/${driver.id}"><img class="dlt-img" src="/img/edt-dlt/delete.png"></a></td>
                            </tr>
                        </#list>
                    </table>
                </div>
