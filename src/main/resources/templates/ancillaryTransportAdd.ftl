...
<div class="wrapper">
    <div class="form-input" style="height: 390px">
        <div class="input-header">
            <a href="/web/ancillaryTransport/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Ancillary Transport</div>
        </div>
        <form name="ancillaryTransport" action="" method="POST" id="form" autocomplete="off">
            ...
            <div class="form-row">
                <div>Garage:</div><@spring.formSingleSelect "ancillaryTransportForm.storageObj", mavs, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Track №:</div><@spring.formInput "ancillaryTransportForm.trackNumber" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <br>
