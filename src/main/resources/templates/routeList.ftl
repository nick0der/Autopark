...
<div class="second-header">
    ...
    <div class="add-button">
        <a href="/web/route/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/route/list">Route</a></div>
</div>
<div>
    <div class="limiter">
                    ...
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            ...
                            <th style="width: 250px">
                                <div class="with-sort">
                                    <div class="sort-text">Finish</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 300px">
                                <div class="with-sort">
                                    <div class="sort-text">Distance</div>
                                    <div class="sort-block">
