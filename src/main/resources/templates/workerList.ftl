...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 175px;">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/worker/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/worker/list">Worker</a></div>
</div>
<div>
    <div class="limiter">
                ...
                <div class="table100">
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            <th class="column-l" style="width: -webkit-max-content">
                                <div class="with-sort">
                                    <div class="sort-text">First Name</div>
                            ...
                            <th style="width: 140px">
                                <div class="with-sort">
                                    <div class="sort-text">Last Name</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 145px">
                                <div class="with-sort">
                                    <div class="sort-text">Patromymic</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 145px">
                                <div class="with-sort">
                                    <div class="sort-text">Speciality</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 95px">
                                <div class="with-sort">
                                    <div class="sort-text">Salary</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 90px">
                                <div class="with-sort">
                                    <div class="sort-text">Experience</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 170px">
                                <div class="with-sort">
                                    <div class="sort-text">Brigade</div>
                                    <div class="sort-block">
                                        <div><img onclick="sortTableZA(6)" id="up6" src="/img/sortarrows/arrowupoff.png"></div>
                                        <div><img onclick="sortTableAZ(6)" id="down6" src="/img/sortarrows/arrowdownoff.png"></div>
                                    </div>
                                </div>
                            </th>
                                ...
                                <script>
                                    $(document).ready(function(){
                                        for (i = 1; i < (document.getElementById("myTable").rows.length); i++) {
                                            var value = document.getElementById("myTable").rows[i].getElementsByTagName("TD")[4].innerHTML;
                                            if ((value.charAt(0) === '1')&&(value.charAt(1) === ' ')){
                                                document.getElementById("myTable").rows[i].getElementsByTagName("TD")[4].innerHTML = '1 year';
                                            }
                                        }
                                    });
                                </script>
                                <td style="text-align: center; width: 70px"><a href="/web/worker/edit/${worker.id}"><img class="edt-img" src="/img/edt-dlt/edit.png"></a></td>
                                <td style="text-align: center; width: 70px" class="column-r"><a onclick="return confirm('Are you sure want to delete? Its impossible to recover the data!')" href="/web/worker/delete/${worker.id}"><img class="dlt-img" src="/img/edt-dlt/delete.png"></a></td>
                            </tr>
                        </#list>
                    </table>
                </div>
