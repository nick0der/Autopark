...
<div class="second-header">
    ...
    <div class="add-button">
        <a href="/web/repair/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/repair/list">Repair</a></div>
</div>
<div>
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                <div class="table100">
                    <table id="myTable">
                        <thead>
                        <tr class="table100-head" style="">
                            <th class="column-l" style="width: 130px">
                                <div class="with-sort">
                            ...
                            <th style="width: 70px">
                                <div class="with-sort">
                                    <div class="sort-text">Engines</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 70px">
                                <div class="with-sort">
                                    <div class="sort-text">Transm-s</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 70px">
                                <div class="with-sort">
                                    <div class="sort-text">Bridges</div>
                                    <div class="sort-block">
                            ...
                            <th style="width: 50px">
                                <div class="with-sort">
                                    <div class="sort-text">Chassis</div>
                                    <div class="sort-block">
                                        <div><img onclick="sortTableZA(7)" id="up7" src="/img/sortarrows/arrowupoff.png"></div>
                                        <div><img onclick="sortTableAZ(7)" id="down7 " src="/img/sortarrows/arrowdownoff.png"></div>
                                    </div>
                                </div>
                            </th>
