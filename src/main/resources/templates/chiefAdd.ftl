...
<div class="wrapper">
    <div class="form-input" style="height: 455px">
        ...
        <form name="chief" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>First name:</div><@spring.formInput "chiefForm.firstName" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Last name:</div><@spring.formInput "chiefForm.lastName" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Patronymic:</div><@spring.formInput "chiefForm.patronymic" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
