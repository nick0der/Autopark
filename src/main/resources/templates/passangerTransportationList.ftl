...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 447px;">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/passangerTransportation/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/passangerTransportation/list">Passanger Transportation</a></div>
</div>
<div>
    <div class="limiter">
                    ...
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            <th class="column-l" style="width: 250px">
                                <div class="with-sort">
                                    <div class="sort-text">Date Transported</div>
                            ...
                            <th style="width: 300px">
                                <div class="with-sort">
                                    <div class="sort-text">Number of Passengers</div>
                                    <div class="sort-block">
