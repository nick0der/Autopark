...
<div class="wrapper">
    <div class="form-input" style="height: 520px; margin-bottom: 50px">
        <div class="input-header">
            <a href="/web/bus/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Bus</div>
        </div>
        <form name="bus" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>Brand:</div><@spring.formInput "busForm.brand" "required minlength=2 maxlength=32" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Seating capacity:</div><@spring.formInput "busForm.seatingCapacity" "required min='0' max='1000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Service class:</div><@spring.formSingleSelect "busForm.serviceClass", types, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Route:</div><@spring.formSingleSelect "busForm.route", mavs1, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Storage object:</div><@spring.formSingleSelect "busForm.storageObj", mavs2, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Track №:</div><@spring.formInput "busForm.trackNumber" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <br>
