...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 260px;">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/teamLeader/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/teamLeader/list">Team Leader</a></div>
</div>
<div>
    <div class="limiter">
                ...
                <div class="table100">
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            <th class="column-l" style="width: 160px">
                                <div class="with-sort">
                        ...
                        <#list teamLeaders as teamLeader>
                            <tr>
                                ...
                                <td style="text-align: center; width: 70px"><a href="/web/teamLeader/edit/${teamLeader.id}"><img class="edt-img" src="/img/edt-dlt/edit.png"></a></td>
                                <td style="text-align: center; width: 70px" class="column-r"><a onclick="return confirm('Are you sure want to delete? Its impossible to recover the data!')" href="/web/teamLeader/delete/${teamLeader.id}"><img class="dlt-img" src="/img/edt-dlt/delete.png"></a></td>
                            </tr>
                        </#list>
                    </table>
                </div>
