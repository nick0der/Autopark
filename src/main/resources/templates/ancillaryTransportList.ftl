...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 350px">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/ancillaryTransport/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/ancillaryTransport/list">Ancillary Transport</a></div>
</div>
<div>
    <div class="limiter">
                ...
                <div class="table100">
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            <th class="column-l" style="width: 275px;">
                                <div class="with-sort">
                            ...
                            <th style="width: 225px;">
                                <div class="with-sort">
                                    <div class="sort-text">Mission</div>
                                    <div class="sort-block">
