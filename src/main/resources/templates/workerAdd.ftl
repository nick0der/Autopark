...
<div class="wrapper">
    <div class="form-input" style="height: 580px">
        ...
        <form name="worker" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>First name:</div><@spring.formInput "workerForm.firstName" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Last name:</div><@spring.formInput "workerForm.lastName" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Patronymic:</div><@spring.formInput "workerForm.patronymic" "required pattern='[A-Za-z]{1,32}'" "text"/>
                <br>
            </div>
            <div class="form-row">
