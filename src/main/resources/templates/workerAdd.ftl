...
<div class="wrapper">
    <div class="form-input" style="height: 580px">
        <div class="input-header">
            <a href="/web/worker/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Worker</div>
        </div>
        <form name="worker" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>First name:</div><@spring.formInput "workerForm.firstName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Name'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Last name:</div><@spring.formInput "workerForm.lastName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Surname'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Patronymic:</div><@spring.formInput "workerForm.patronymic" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Patronymic'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Speciality:</div><@spring.formSingleSelect "workerForm.speciality", types, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Salary:</div><@spring.formInput "workerForm.salary" "required min='0' max='10000000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Experience:</div><@spring.formInput "workerForm.experience" "required min='0' max='100'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Working team:</div><@spring.formSingleSelect "workerForm.workingTeam", mavs, ""/>
                <br>
            </div>
            <br>
