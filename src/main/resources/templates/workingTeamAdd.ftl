...
<div class="wrapper">
    <div class="form-input" style="height: 265px">
        ...
        <form name="workingTeam" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>Number:</div><@spring.formInput "workingTeamForm.number" "required min='0' max='10000'" "number"/>
                <script src="/js/datepicker.js"></script>
            </div>
            <div class="form-row">
                <div>Team Leader:</div><@spring.formSingleSelect "workingTeamForm.teamLeader", mavs, ""/>
                <br>
            </div>
            <br>
