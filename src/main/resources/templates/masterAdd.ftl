...
<div class="wrapper">
    <div class="form-input" style="height: 520px">
        <div class="input-header">
            <a href="/web/master/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Master</div>
        </div>
        <form name="master" action="" method="POST" id="form" autocomplete="off">
            <div class="form-row">
                <div>First name:</div><@spring.formInput "masterForm.firstName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Name'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Last name:</div><@spring.formInput "masterForm.lastName" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Surname'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Patronymic:</div><@spring.formInput "masterForm.patronymic" "required pattern='^[A-Z]{1}[a-z]{2,32}' title='example: Patronymic'" "text"/>
                <br>
            </div>
            <div class="form-row">
                <div>Salary:</div><@spring.formInput "masterForm.salary" "required min='0' max='10000000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Experience:</div><@spring.formInput "masterForm.experience" "required min='0' max='100'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Chief:</div><@spring.formSingleSelect "masterForm.chief", mavs, ""/>
                <br>
            </div>
            <br>
