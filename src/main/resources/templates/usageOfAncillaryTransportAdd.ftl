...
<div class="wrapper">
    <div class="form-input" style="height: 265px">
        <div class="input-header">
            <a href="/web/usageOfAncillaryTransport/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Usage Of Ancillary Transport</div>
        </div>
        <form name="usageOfAncillaryTransport" action="" method="POST" id="form" autocomplete="off">
            ...
            <div class="form-row">
                <div>Transport:</div><@spring.formSingleSelect "usageOfAncillaryTransportForm.ancillaryTransport", mavs, ""/>
                <br>
            </div>
            <@spring.formInput "usageOfAncillaryTransportForm.dateUsed" "required style='display:none'" "text"/>
            <br>
