...
<div class="wrapper">
    <div class="form-input" style="height: 455px; margin-bottom: 50px">
        <div class="input-header">
            <a href="/web/taxi/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Taxi</div>
        </div>
        <form name="taxi" action="" method="POST" id="form" autocomplete="off">
            ...
            <div class="form-row">
                <div>Type:</div><@spring.formSingleSelect "taxiForm.bodyType", types, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Storage object:</div><@spring.formSingleSelect "taxiForm.storageObj", mavs, ""/>
                <br>
            </div>
            <div class="form-row">
                <div>Track №:</div><@spring.formInput "taxiForm.trackNumber" "required min='0' max='100000'" "number"/>
                <br>
            </div>
            <br>
