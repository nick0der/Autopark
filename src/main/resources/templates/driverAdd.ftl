...
<div class="wrapper">
    <div class="form-input" style="height: 520px">
        <div class="input-header">
            <a href="/web/driver/list"><img src="/img/arrowback.png" width="35px" style="margin-top: 9px"></a>
            <div>Driver</div>
        </div>
        <form name="driver" action="" method="POST" id="form" autocomplete="off">
            ...
            <div class="form-row">
                <div>Salary:</div><@spring.formInput "driverForm.salary" "required min='0' max='10000000'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Experience:</div><@spring.formInput "driverForm.experience" "required min='0' max='100'" "number"/>
                <br>
            </div>
            <div class="form-row">
                <div>Transport:</div><@spring.formSingleSelect "driverForm.transport", mavs, ""/>
                <br>
            </div>
            <br>
