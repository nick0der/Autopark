...
<div class="second-header">
    <div class="form-group has-search" id="search-block" style="left: 190px;">
        <span class="fa fa-search form-control-feedback"></span>
        <input class="form-control" type="text" placeholder="Search.." aria-label="Search" id="searchForm" onkeyup="search()">
    </div>
    <div class="add-button">
        <a href="/web/workingTeam/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/workingTeam/list">Brigade</a></div>
</div>
<div>
    <div class="limiter">
                    ...
                    <table id="myTable">
                        ...
                        <tr class="table100-head">
                            ...
                            <th style="width: 600px">
                                <div class="with-sort">
                                    <div class="sort-text">Team Leader</div>
                                    <div class="sort-block">
