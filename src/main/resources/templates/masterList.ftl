...
<div class="second-header">
    ...
    <div class="add-button">
        <a href="/web/master/create"><p>Add a new record</p></a>
    </div>
    <div class="title-class"><a href="/web/master/list">Master</a></div>
</div>
<div>
    <div class="limiter">
                    ...
                    <table id="myTable">
                        ...
                        <#list masters as master>
                            <tr>
                                ...
                                <td style="text-align: center; width: 70px"><a href="/web/master/edit/${master.id}"><img class="edt-img" src="/img/edt-dlt/edit.png"></a></td>
                                <td style="text-align: center; width: 70px" class="column-r"><a onclick="return confirm('Are you sure want to delete? Its impossible to recover the data!')" href="/web/master/delete/${master.id}"><img class="dlt-img" src="/img/edt-dlt/delete.png"></a></td>
                            </tr>
                        </#list>
                    </table>
                </div>
